...
\begin{enumerate}[leftmargin=0.3in,itemsep=0.4em,parsep=0pt]
\item Batista, M.; \textbf{Henrique, A.} ``Nuts and Bolts of Punctuated Equilibrium: Theory, Methods, and Applications in Brazil.'' In: Sátyro, N.; Marenco, A.; Batista, M.\ (Eds.), \textit{Policy Process Frameworks in Practice: Critical Analysis From Brazil and Latin America}. Abingdon: Routledge, 2026, pp.\ 59--91.
...
\cvsubsection{Open Teaching Materials}
\entryplain{\textit{Social Scientist's Survival Manual for AI} --- guide with glossary, usage criteria, ~29 prompt templates, and an AI usage declaration template.}{2026}
\entryplain{Workshop \textit{Introduction to Generative AI in the Social Sciences} (CEM/USP). \href{https://github.com/andersonheri/workshop-iag-ciencias-sociais}{github.com/andersonheri/workshop-iag-ciencias-sociais}.}{2026}
...
\entryplain{Network for Subnational Politics Studies in Latin America (REPSAL)}{2026--present}
...
\cvsubsection{Software Packages}
Author of the \textbf{acR} package (\textit{Content Analysis in R}), available on CRAN --- an integrated content analysis pipeline combining LLM-assisted qualitative coding with classical quantitative text analysis. \href{https://ahenriquecp.com/acR/}{ahenriquecp.com/acR}.
