...
Author of the \textbf{acR} package (\textit{Content Analysis in R}), available on CRAN --- an integrated content analysis pipeline combining LLM-assisted qualitative coding with classical quantitative text analysis. \href{https://cran.r-project.org/package=acR}{cran.r-project.org/package=acR}.
