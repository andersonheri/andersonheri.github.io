...
Autor do pacote \textbf{acR} (\textit{Content Analysis in R}), disponível no CRAN --- pipeline integrado de análise de conteúdo combinando codificação qualitativa assistida por LLMs e análise textual quantitativa. \href{https://cran.r-project.org/package=acR}{cran.r-project.org/package=acR}.
