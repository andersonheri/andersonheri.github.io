...
\begin{center}
{\LARGE \textbf{Anderson Henrique}}\\[0.5em]
...
\href{https://scholar.google.com/citations?user=YGNu2fsAAAAJ}{Google Scholar} \quad|\quad
...
\begin{enumerate}[leftmargin=0.3in,itemsep=0.4em,parsep=0pt]
\item Batista, M.; \textbf{Henrique, A.}; Porto, L. ``Investimento ou aprendizado? Incentivos da reeleição sobre a promoção de capacidades estatais nos municípios brasileiros.'' \textit{Revista Brasileira de Ciências Sociais}, 41, e026, 2026.
...
\begin{enumerate}[leftmargin=0.3in,itemsep=0.4em,parsep=0pt]
\item Batista, M.; \textbf{Henrique, A.} ``Nuts and Bolts of Punctuated Equilibrium: Theory, Methods, and Applications in Brazil.'' In: Sátyro, N.; Marenco, A.; Batista, M.\ (Eds.), \textit{Policy Process Frameworks in Practice: Critical Analysis From Brazil and Latin America}. Abingdon: Routledge, 2026, p.\ 59--91.
...
\cvsubsection{Materiais didáticos abertos}
\entryplain{\textit{Manual de Sobrevivência do Cientista Social com IA} --- guia com glossário, critérios de uso, ~29 modelos de prompt e template de declaração de uso de IA.}{2026}
\entryplain{Workshop \textit{Introdução à Inteligência Artificial Generativa nas Ciências Sociais} (CEM/USP). \href{https://github.com/andersonheri/workshop-iag-ciencias-sociais}{github.com/andersonheri/workshop-iag-ciencias-sociais}.}{2026}
...
\entryplain{Red de Estudios sobre Política Subnacional en América Latina (REPSAL)}{2026--atual}
...
\cvsubsection{Pacotes de software}
Autor do pacote \textbf{acR} (\textit{Content Analysis in R}), disponível no CRAN --- pipeline integrado de análise de conteúdo combinando codificação qualitativa assistida por LLMs e análise textual quantitativa. \href{https://ahenriquecp.com/acR/}{ahenriquecp.com/acR}.
